...
def chat_agent(request: ChatRequest):
    try:
        ...
        response_text = ClaudeService.chat(messages_dict, request.goal_context)
...
def onboarding(username: str, goal: str, session: Session = Depends(get_session)):
    try:
        ...
        short_goal = ClaudeService.summarize_goal(goal)
        ...
        initial_nodes = ClaudeService.generate_learning_route(goal)
